...
exclude_libs = ['_ssl', 'pyreadline', 'doctest','optparse', 'pickle', 'matplotlib', "BaseHTTPServer", "SocketServer", "dateutil", "email", "httplib", "itertools", "mpl_toolkits", "numpy.f2py", "pydoc_data", "random", "urllib", "urllib2", "xml", "zipfile", "zipimport", "scipy.sparse.linalg.eigen.arpack", "scipy.sparse._sparsetools"]
