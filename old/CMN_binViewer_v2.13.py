...
gifsicle: Copyright © 1997-2013 Eddie Kohler""")
    ...
    def initUI(self):
        ...
        # Confirmation video
        blankImage = ImageTk.PhotoImage(img.fromarray(128+np.zeros(shape=(128, 128))).convert("RGB"))
        self.confirmationVideoLabel = Label(self, image = blankImage)
        self.confirmationVideoLabel.image = blankImage
        self.confirmationVideoLabel.grid(row = 5, column = 0, rowspan = 3)
