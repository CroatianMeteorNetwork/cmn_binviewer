...
class binViewer(Frame):
    ...
    def askdirectory(self):
        ...
        self.dir_path = tkFileDialog.askdirectory(initialdir = self.dir_path, parent = self.parent, mustexist = False, title = "Open the directory with FF*.bin files, then click OK") #Opens the file dialog
    ...
    def make_master_flat(self):
        ...
        flat_dir = tkFileDialog.askdirectory(initialdir = self.dir_path, parent = self.parent, mustexist = False, title = "Open the directory with flat frames, then click OK")
        if flat_dir == '': 
